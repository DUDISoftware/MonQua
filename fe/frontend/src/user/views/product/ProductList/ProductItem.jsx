...
const ProductItem = ({ product }) => (
    <div className="bg-white rounded-xl border border-gray-200 p-3 flex flex-col hover:shadow-md transition cursor-pointer relative">
        ...
        <button className="mt-auto bg-[#F6F6F6] text-[#22C55E] py-1.5 rounded-lg text-sm font-medium border border-[#22C55E] hover:bg-[#22C55E] hover:text-white transition">
            Xem Chi Tiết
        </button>
    </div>
);
