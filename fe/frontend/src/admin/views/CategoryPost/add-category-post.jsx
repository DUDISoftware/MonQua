...
import { addPostCategory } from "../../../api/post.category.api.js";
...
const AddCategoryPost = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await addPostCategory(form, token);
    ...
    return (
        <Box sx={{ padding: 3, backgroundColor: '#fff', borderRadius: 2, boxShadow: 1 }}>
            <Typography variant="h6" fontWeight={600} mb={2}>Thêm danh mục bài viết mới</Typography>
