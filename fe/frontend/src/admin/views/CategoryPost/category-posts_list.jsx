...
import { getPostCategories, deletePostCategory } from "../../../api/post.category.api.js";
                            ...
                            categories.map((cat, idx) => (
                                <TableRow key={cat._id}>
                                    ...
                                    <TableCell align="center">
                                        <Button variant="outlined" color="primary" size="small" onClick={() => navigate(`/admin/category-posts/${cat._id}`)} sx={{ mr: 1 }}>Xem</Button>
                                        <Button variant="outlined" color="secondary" size="small" onClick={() => navigate(`/admin/category-posts/update/${cat._id}`)} sx={{ mr: 1 }}>Sửa</Button>
